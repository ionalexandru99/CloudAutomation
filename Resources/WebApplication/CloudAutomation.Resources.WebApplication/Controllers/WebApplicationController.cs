...
namespace CloudAutomation.Resources.WebApplication.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class WebApplicationController : Controller
    {
        ...
        private readonly ILogger<WebApplicationController> _logger;
        ...
        public WebApplicationController(
            ...
            ILogger<WebApplicationController> logger)
        {
