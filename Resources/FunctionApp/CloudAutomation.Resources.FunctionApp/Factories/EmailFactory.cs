...
namespace CloudAutomation.Resources.FunctionApp.Factories
{
    public class EmailFactory : IEmailFactory
    {
        ...
        public CreatedResourceEmail GetEmailDetailsFromResourceData(IFunctionApp azureResource, WorkItem workItem)
        {
        ...
        private static Dictionary<string,string> GetResourceValues(IFunctionApp azureResource)
        {
            if (azureResource == null) throw new ArgumentNullException(nameof(azureResource));

            var storageAccount = azureResource.StorageAccount;
            ...
            var dict =  new Dictionary<string, string>
            {
                ...
                {"Storage Account ConnectionString", storageConnectionString}
            };
