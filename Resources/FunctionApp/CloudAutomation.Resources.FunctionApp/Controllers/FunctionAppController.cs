...
namespace CloudAutomation.Resources.FunctionApp.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class FunctionAppController : Controller
    {
        ...
        private readonly ILogger<FunctionAppController> _logger;

        public FunctionAppController(
            IGetWorkItem<WorkItem> getWorkItem,
            IEmailFactory emailFactory,
            IEmailClient emailClient,
            IUpdateStateClient updateStateClient,
            ILogger<FunctionAppController> logger)
        {
