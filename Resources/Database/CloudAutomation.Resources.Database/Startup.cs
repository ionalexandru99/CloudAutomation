...
using CloudAutomation.Resources.Database.Processors;
using CloudAutomation.Resources.Database.Processors.Interfaces;
using CloudAutomation.Resources.Database.Services;
...
namespace CloudAutomation.Resources.Database
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IResourceProcessor<ISqlDatabase>, ResourceProcessor<ISqlDatabase>>();
            ...
            services.AddSingleton<IAzureProcessor<ISqlDatabase>, AzureProcessor<ISqlDatabase>>();
